        ...
        <div class="container mx-auto px-6 flex relative py-16">
            <div class="sm:w-2/3 lg:w-2/5 flex flex-col relative z-20">
                ...
                <p class="text-sm sm:text-base text-gray-700 dark:text-white">
                    Agora temos novos filmes e séries disponíveis! Explore nossa biblioteca atualizada e descubra os lançamentos exclusivos que preparamos para você.
                </p>
                <div class="flex mt-8">
                    <a href="#" class="uppercase py-2 px-4 rounded-lg bg-blue-700 border-2 border-transparent text-white text-md mr-4 hover:bg-blue-950 transition-all duration-300 ease-in-out">
                        Confira Agora
                    </a>
                    <a href="#" class="uppercase py-2 px-4 rounded-lg bg-transparent border-2 border-blue-700 text-blue-700 dark:text-white hover:bg-blue-950 hover:text-white text-md transition-all duration-300 ease-in-out  ">
                        Veja os Lançamentos
                    </a>
                </div>
            </div>
            <div class="hidden sm:block sm:w-2/3 lg:w-4/5 xl:w-3/4 relative rounded-lg overflow-hidden ">
                <img src="https://img.freepik.com/free-photo/medium-shot-smiley-couple-couch_23-2149145063.jpg?t=st=1741137330~exp=1741140930~hmac=a2157800e4ecb298e5366137b3879d74afa70d8d34ee016cfd26812db1487d71&w=1380" class="w-full h-auto max-w-3/4 m-auto" alt="Streaming News"/>
            </div>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            <div class="mr-auto place-self-center lg:col-span-7">
                <h1 class="max-w-5xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">
                    Ainda estou aqui!</h1>
                <p class="max-w-30xl mb-6 font-sans text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-white">O
                    filme brasileiro "Ainda Estou Aqui", dirigido por Walter Salles, fez história ao vencer o Oscar de
                    Melhor Filme Internacional na 97ª cerimônia da Academia, realizada em 2 de março de 2025. Este é o
                    primeiro filme brasileiro a conquistar essa categoria desde a criação do prêmio em 1957.
                    A vitória de "Ainda Estou Aqui" no Oscar representa um marco significativo para o cinema brasileiro,
            ...
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex items-center justify-center overflow-hidden relative">
                ...
                <div class="absolute inset-0 bg-gradient-to-t from-black to-transparent opacity-40 rounded-xl"></div>
    ...
    <section class="pt-20 md:pt-40">
        <div class="container mx-auto px-8 lg:flex">
            <div class="text-center lg:text-left lg:w-1/2">
                <h1 class="text-4xl lg:text-5xl xl:text-2xl font-bold leading-none dark:text-white ">O site está sendo atualizado no momento para receber informações agora!</h1>
                <p class="text-xl lg:text-2xl mt-6 font-serif dark:text-white">estamos sempre trabalhando para melhorar a qualidade do usuário</p>
